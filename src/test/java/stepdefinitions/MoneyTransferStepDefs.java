...
public class MoneyTransferStepDefs {
    ...
    public void user_provides_the_balance(String string) {
        Driver.waitAndSendText(moneyTransferPage.balance,string); //string degeri feature da "" olan kisim
        Driver.waitAndSendText(moneyTransferPage.balanceCent,"2"); //cent kismini doldurduk
    }
    @When("user types the description")
    public void user_types_the_description() {
        Driver.waitAndSendText(moneyTransferPage.description,"school money");
    }
