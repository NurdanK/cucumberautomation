...
//        THIS IS SAME AS @Test in Junit or test ng
    ...
    public void verify_the_result_has_tea_pot_related_results() {
        ...
        Assert.assertTrue(false);// failing on purpose to take a screenshot
    }
    ...
    @When("user search for {string}")                     //parameter eklendi otomatik//dynamic oldu!// "" string icine koyduk
